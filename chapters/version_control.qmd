...
Add link to R github book you recommended: https://happygitwithr.com/

Add steps on very basic how to preform first clone, commit, and push 
1. first do this 
2. then this
3. you get it 
It was still a little teqnical for me because I don't know git or github so I still have to read other things to learn exactly how it works. 
* Also please upload your most recent copy of the book so I can edit it :) 
